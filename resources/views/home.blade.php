...
<div class="container mx-auto px-4">
    @if(auth()->user()->role === 'admin')
        ...
        <div class="mb-8">
            <div class="bg-gradient-to-r from-[#1a4175] to-[#2563eb] rounded-lg shadow-lg p-6 text-white">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-[#1a4175] to-[#2563eb] px-6 py-4">
                    <h2 class="text-xl font-semibold text-white">¡Bienvenido, {{ auth()->user()->name }}!</h2>
                    <p class="text-white opacity-90 mt-1">Sistema de Control de Asistencia</p>
                </div>
