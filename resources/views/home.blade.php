        ...
        @else
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white rounded-t-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <!-- Estado del Día -->
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100" style="max-width: 500px; margin: 0 auto;">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <div class="bg-blue-100 rounded-full p-1">
                                    <svg class="w-3 h-3 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width: 300px !important;">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                ...
                <div class="bg-white rounded-b-xl shadow-sm border-x border-b border-gray-200 p-6">
                    <div class="grid grid-cols-2 gap-4" style="max-width: 500px; margin: 0 auto;">
                        <!-- Botón/Estado de Entrada -->
                        <div>
                            @if(!$todayAttendance)
                                <form action="{{ route('attendance.check-in') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="w-full bg-white hover:bg-blue-50 border-2 border-blue-500 rounded-xl p-4 transition-all duration-200 group" style="max-width: 500px;">
                                        <div class="flex flex-col items-center">
                                            <div class="bg-blue-100 rounded-full p-2 mb-3 group-hover:bg-blue-200 transition-colors">
                                                <svg class="w-4 h-4 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width: 300px !important;">
                            ...
                            @else
                                <div class="bg-green-50 rounded-xl p-4 border-2 border-green-200" style="max-width: 500px;">
                                    <div class="flex flex-col items-center">
                                        <div class="bg-green-100 rounded-full p-2 mb-3">
                        ...
                        <div>
                            @if($todayAttendance && !$todayAttendance->check_out_time)
                                <form action="{{ route('attendance.check-out') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="w-full bg-white hover:bg-indigo-50 border-2 border-indigo-500 rounded-xl p-4 transition-all duration-200 group" style="max-width: 500px;">
                                        <div class="flex flex-col items-center">
                                            <div class="bg-indigo-100 rounded-full p-2 mb-3 group-hover:bg-indigo-200 transition-colors">
                                                <svg class="w-4 h-4 text-indigo-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width: 300px !important;">
                            ...
                            @elseif($todayAttendance && $todayAttendance->check_out_time)
                                <div class="bg-indigo-50 rounded-xl p-4 border-2 border-indigo-200" style="max-width: 500px;">
                                    <div class="flex flex-col items-center">
                                        <div class="bg-indigo-100 rounded-full p-2 mb-3">
                                            <svg class="w-4 h-4 text-indigo-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width: 300px !important;">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                            </svg>
                                        </div>
                            ...
                            @else
                                <div class="bg-gray-50 rounded-xl p-4 border-2 border-gray-200" style="max-width: 500px;">
                                    <div class="flex flex-col items-center">
                                        <div class="bg-gray-100 rounded-full p-2 mb-3">
                                            <svg class="w-4 h-4 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width: 300px !important;">
                    ...
                    <!-- Resumen del Día -->
                    <div class="mt-6 pt-6 border-t border-gray-100" style="max-width: 500px; margin: 0 auto;">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('attendance.list') }}" class="text-blue-600 hover:text-blue-700 font-medium text-sm flex items-center">
                                Ver mi historial
                                <svg class="w-3 h-3 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width: 300px !important;">
