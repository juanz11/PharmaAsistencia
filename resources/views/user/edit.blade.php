    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-[#1a4175] to-[#1F4591] rounded-t-lg shadow-lg p-6 mb-1">
                <h2 class="text-2xl font-bold text-white mb-2">{{ __('Mi Perfil') }}</h2>
            ...
            <div class="bg-white rounded-b-lg shadow-lg">
                ...
                <form method="POST" action="{{ route('user.update') }}" class="p-6 space-y-6">
                    ...
                    <div class="flex justify-end pt-6 border-t border-gray-200">
                        <button type="submit" 
                            class="px-6 py-3 bg-gradient-to-r from-[#1a4175] to-[#1F4591] text-white font-semibold rounded-lg shadow-md hover:from-[#163670] hover:to-[#1a4175] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1F4591] transition-all duration-200 transform hover:scale-[1.02] flex items-center">
